...
`,
  ...
  },
  {
    ...
    type: "question",
    phase: "Step 1 of 4",
    paal: `Outline a schedule blueprint (event title, notify time) and construct the component shell.
...
2. Shell component: Declare your component returning an empty <div />.`,
  ...
  },
  {
    ...
    type: "question",
    phase: "Step 2 of 4",
    paal: `Store scheduled reminders in state; show an event row for each entry, or a "No events scheduled" fallback.
...
3. Render entries: Map through items, passing key={item.id}.`,
  ...
  },
  {
    ...
    type: "question",
    phase: "Step 3 of 4",
    paal: `Connect the title and date picker inputs to state to track user choices live.
...
2. Wire inputs: Connect value and onChange to each state variable.`,
  ...
  },
  {
    ...
    type: "question",
    phase: "Step 4 of 4",
    paal: `Prevent default submit refresh, append the event to the schedule list, and reset the inputs.
